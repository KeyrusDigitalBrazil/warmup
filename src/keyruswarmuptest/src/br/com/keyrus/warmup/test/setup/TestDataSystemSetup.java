 ...
 */
package br.com.keyrus.warmup.test.setup;
...
import br.com.keyrus.warmup.test.constants.KeyruswarmupTestConstants;
import br.com.keyrus.warmup.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = KeyruswarmupTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/keyruswarmuptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/keyruswarmuptest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/keyruswarmuptest/import/cstickets.impex");
			...
			importImpexFile(context, "/keyruswarmuptest/import/csquotes.impex");
		}
	}
}
