 ...
 */
package br.com.keyrus.warmup.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, KeyruswarmupFulfilmentProcessConstants.PARENT_PROCESS);
