 ...
 */
package br.com.keyrus.warmup.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(KeyruswarmupFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(KeyruswarmupFulfilmentProcessConstants.PARENT_PROCESS);
