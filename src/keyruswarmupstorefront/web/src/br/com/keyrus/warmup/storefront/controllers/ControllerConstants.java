 ...
 */
package br.com.keyrus.warmup.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String ProductShopWindowComponent = _Prefix + ProductShopWindowComponentModel._TYPECODE + _Suffix; // NOSONAR
