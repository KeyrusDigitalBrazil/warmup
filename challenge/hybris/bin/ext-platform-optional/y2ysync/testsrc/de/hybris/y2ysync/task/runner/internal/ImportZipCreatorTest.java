...
public class ImportZipCreatorTest extends ServicelayerTransactionalBaseTest
{
	...
	public void shouldSaveSyncImpExMediaWithLongAttributes()
	{
		...
		media.setImpexHeader(RandomStringUtils.randomAlphanumeric(10_000));
		media.setDataHubColumns(RandomStringUtils.randomAlphanumeric(10_000));
		media.setSyncType(typeService.getComposedTypeForCode("Product"));
