...
Since 6.1 Hybris doesn't ship ImageMagick with the platform anymore,
so if you need it - you have to install it by your own.
Find and download the latest release from http://www.imagemagick.org,
following the instructions presented there.

Under mediaconversion project.properties you will find ImageMagick specific
configuration details, like installation directory, etc...
Adjust it to your needs in your local.properties.
You have to set at least the following properties:
- imagemagick.bindir
- imagemagick.configuration.directory

For security reasons we recommend to be up to date with the latest releases and
potential vulnerabilities reported.
Quite often it's strongly recommended to configure especially your policy.xml file.
