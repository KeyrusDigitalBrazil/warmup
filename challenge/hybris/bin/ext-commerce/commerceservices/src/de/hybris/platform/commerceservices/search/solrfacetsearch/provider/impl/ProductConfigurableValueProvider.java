 ...
 */
public class ProductConfigurableValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
			...
			throws FieldValueProviderException
	{
		...
		if (model instanceof ProductModel)
		{
			...
			final Boolean configurable = Boolean.valueOf(getProductConfigurableChecker().isProductConfigurable(product));
