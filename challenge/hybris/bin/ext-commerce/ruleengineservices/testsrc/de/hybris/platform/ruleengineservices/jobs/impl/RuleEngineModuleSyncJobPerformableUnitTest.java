...
public class RuleEngineModuleSyncJobPerformableUnitTest
{
	...
	public void setUp()
	{
		...
		when(ruleEngineCronJob.getSrcModuleName()).thenReturn(SRC_MODULE_NAME);
	...
	public void testPerformOk()
	{
		...
		when(ruleMaintenanceService.synchronizeModules(SRC_MODULE_NAME, MODULE_NAME)).thenReturn(result);
