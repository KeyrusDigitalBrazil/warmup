...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/keyruswarmupstorefront/electronics/en",
						"https://electronics.local:9002/keyruswarmupstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/keyruswarmupstorefront/electronics/en",
						"https://electronics.local:9002/keyruswarmupstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/keyruswarmupstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/keyruswarmupstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/keyruswarmupstorefront/electronics/en",
						"https://electronics.local:9002/keyruswarmupstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/keyruswarmupstorefront",
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/keyruswarmupstorefront/electronics/en",
						"https://electronics.local:9002/keyruswarmupstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
