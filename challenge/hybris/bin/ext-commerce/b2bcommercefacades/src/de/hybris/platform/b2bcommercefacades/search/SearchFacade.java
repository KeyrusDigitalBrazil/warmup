 ...
 */
package de.hybris.platform.b2bcommercefacades.search;
...
public interface SearchFacade<ITEM, STATE extends SearchStateData>
{
	 ...
	 */
	SearchPageData<ITEM> search(final STATE searchState, final PageableData pageableData);
	 ...
	 */
	List<AutocompleteSuggestionData> autocomplete(final STATE searchState);
