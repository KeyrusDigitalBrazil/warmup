...
<%
	...
	{ 
		...
		while ( i.hasNext() )
		{
			...
			out.println("<tr><td>"+XSSEncoder.encodeHTML(Integer.toString((entry.getEntryNumber()+1)))+"</td><td>"+XSSEncoder.encodeHTML(entry.getInfo())+"</td><td>"+XSSEncoder.encodeHTML(entry.getQuantity()) +"</td><td><a href='cart.jsp?delproduct="+XSSEncoder.encodeURL(Integer.toString(entry.getEntryNumber()))+"'>delete</td></tr><br>");
		}
		out.println("</table>");
		leer = false;
	}
