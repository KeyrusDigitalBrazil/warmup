...
public class DeeplinkUrlDaoImplTest extends HybrisJUnit4TransactionalTest
{
	...
	private List<DeeplinkUrlRuleModel> createDeeplinkUrlRules()
	{
		...
		deeplinkRule1.setApplicableType(getTypeService().getComposedTypeForCode("DeeplinkUrl"));
		...
		deeplinkRule2.setApplicableType(getTypeService().getComposedTypeForCode("DeeplinkUrl"));
		...
		deeplinkRule3.setApplicableType(getTypeService().getComposedTypeForCode("DeeplinkUrl"));
