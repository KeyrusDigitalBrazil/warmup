...
module.exports = function(grunt) {
    ...
    // Compilation
    // -------------------------------------------------------------------------------------------------
    grunt.registerTask('compile_only', ['sanitize', 'linting', 'multipleCopySources', 'injectExtensionsImports', 'multipleNGTemplates', 'checkNoFocus', 'checkNoForbiddenNameSpaces', 'styling_only']);
