 ...
 */
package br.com.keyrus.warmup.core.suggestion;
...
import br.com.keyrus.warmup.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/keyruswarmupcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
