...
{
	/**
	 * Returns the {@link AbstractCMSComponentData} object by component id restricted by categoryCode or productCode or catalogCode.
	 * @param componentId the component id
	 * @param categoryCode the optional category code
	 * @param productCode the optional product code
	 * @param catalogCode the optional catalog code
	 * @return the {@link AbstractCMSComponentData} object
	 * @throws CMSItemNotFoundException if the component is restricted or not visible.
	 */
	...
	/**
	 * Returns the list of found {@link AbstractCMSComponentData} in {@link SearchPageData}. The result is restricted by categoryCode or productCode or catalogCode.
	 * @param componentIds the list of component id
	 * @param categoryCode the optional category code
	 * @param productCode the optional product code
	 * @param catalogCode the optional catalog code
	 * @param searchPageData the searchPageData contains requested pagination and sorting information
