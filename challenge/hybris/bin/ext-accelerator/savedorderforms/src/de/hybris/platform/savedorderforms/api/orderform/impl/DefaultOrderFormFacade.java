...
public class DefaultOrderFormFacade implements OrderFormFacade
{
	...
	@Override
	public OrderFormData createOrderForm(final OrderFormData orderFormData)
	{
	...
	@Override
	public OrderFormData updateOrderForm(final String code, final OrderFormData orderFormData)
	{
	...
	@Override
	public void removeOrderForm(final String code)
	{
		final OrderFormModel orderFormModel = getOrderFormService().getOrderFormForCode(code);
		if (orderFormModel != null)
		{
	...
	@Override
	public void addOrderFormToCart(final String orderFormCode, final String cartId) throws CommerceCartModificationException
	{
		final OrderFormModel orderFormModel = getOrderFormService().getOrderFormForCode(orderFormCode);

		if (orderFormModel != null)
		{
			final List<CartModel> carts = getCommerceCartService().getCartsForSiteAndUser(getBaseSiteService().getCurrentBaseSite(),
			...
			for (final OrderFormEntryModel entry : orderFormModel.getEntries())
			{
