...
public class DefaultFallbackOutboundRequestErrorParser<T extends MonitoredRequestErrorModel> extends AbstractErrorParser<T>
{
	...
	private static final String ERROR_MESSAGE = "HttpStatus: %s: %s";
	...
	public T parseErrorFrom(Class<T> errorClass, final int statusCode, final String responseBody)
	{
		try
		{
			return error(errorClass, ERROR_CODE, StringUtils.abbreviate(String.format(ERROR_MESSAGE, statusCode, responseBody), 255));
		}
