...
<html>
<head>
    <title>Welcome to initiateyaasconfigurationsync</title>
...
<div class="container">
    ...
    <h2>Welcome to "initiateyaasconfigurationsync" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/initiateyaasconfigurationsync-items.xml</b> - here you can model your items</li>
            <li><b>resources/initiateyaasconfigurationsync-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/initiateyaasconfigurationsync-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/initiateyaasconfigurationsync-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/initiateyaasconfigurationsync-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
