...
/******/ 	return __webpack_require__(__webpack_require__.s = "./jsTarget/web/features/merchandisingsmartedit/merchandisingsmartedit.ts");
/******/ })
/************************************************************************/
/******/ ({
...
angular__WEBPACK_IMPORTED_MODULE_0__["module"]('merchandisingsmartedit', [
    ...
    var setUpContextualMenu = function () {
        contextualMenuService.addItems({
            MerchandisingCarouselComponent: [{
                    ...
                    condition: function (configuration, event) {
                        return true;
                    },
                    callback: function (configuration, event) {
                        sharedDataService.get('contextDrivenServicesMerchandisingUrl').then(function (url) {
