...
public class ProductConfigureBreadcrumbBuilderTest
{
	...
	public void setup()
	{
		...
		breadCrumbBuilder.setCpqConfigurableChecker(cpqConfigurableChecker);
	...
	public void testGetBaseProductForVariant()
	{
		...
		final ProductModel result = breadCrumbBuilder.getBaseProduct(mockVariant);
	...
	public void testGetBaseProductForConfigurableProduct()
	{
		...
		final ProductModel result = breadCrumbBuilder.getBaseProduct(mockProduct);
	...
	public void testGetBaseProductForPartiallyConfiguredVariant()
	{
		...
		final ProductModel result = breadCrumbBuilder.getBaseProduct(mockPartiallyConfiguredVariant);
