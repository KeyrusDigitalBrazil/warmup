...
public class MissingKeyNavigationPropertyException extends InvalidDataException
{
	public MissingKeyNavigationPropertyException(final String entityType, final String propertyName)
	{
		super("missing_key", "Key NavigationProperty [" + propertyName + "] is required for EntityType [" + entityType + "].");
	}
}
