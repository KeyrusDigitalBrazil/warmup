...
public class DefaultCisSubscriptionFacade extends AbstractSubscriptionFacade
{
	...
	/* converters */
	private Converter<ResponseEntity, SubscriptionPaymentData> cisPaymentConverter;
	...
	private Converter<ResponseEntity, CCPaymentInfoData> cisCCPaymentInfoDataConverter;
	...
	public SubscriptionPaymentData updateProfile(final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		...
		final ResponseEntity<CisSubscriptionProfileResult> response = getCisSubscriptionService().updateProfile(
			...
			final String cancelReturnUrl, final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		...
		try
		{
			final ResponseEntity<CisSubscriptionTransactionResult> response = getCisSubscriptionService().initializeTransaction(
	...
	{
		final ResponseEntity<Void> hpfUrlResponse = getCisSubscriptionService().hpfUrl(getCisClientRef(null));

		if (hpfUrlResponse == null || hpfUrlResponse.getHeaders().getLocation() == null)
		{
		...
		try
		{
			return hpfUrlResponse.getHeaders().getLocation().toURL().toString();
		}
			...
			final String authorizationRequestToken, final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		...
		ResponseEntity<CisSubscriptionTransactionResult> response = null;
		try
		{
			...
			final boolean propagate, final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		...
		final ResponseEntity<CisPaymentMethodResult> response = getCisSubscriptionService().updatePaymentMethod(
			...
			final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		...
		final ResponseEntity<CisSubscriptionTransactionResult> response = getCisSubscriptionService().replacePaymentMethod(
	...
	{
		final ResponseEntity<CisSubscriptionData> response = getCisSubscriptionService().replacePaymentMethod(getCisClientRef(null),
				subscriptionId, paymentMethodId, effectiveFrom);

		return getCisSubscriptionConverter().convert(response.getBody());
	}
	...
	{
		final ResponseEntity<CisSubscriptionTransactionResult> response = getCisSubscriptionService().updateSubscription(
			...
			final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		...
		final ResponseEntity<CisSubscriptionData> response = getCisSubscriptionService().updateSubscription(getCisClientRef(null),
				updateRequest);
		response.getBody();
		return getCisSubscriptionConverter().convert(response.getBody());
	}
	...
	{
		final ResponseEntity<CisSubscriptionProfileResult> response = getCisSubscriptionService().getCustomerProfile(
				getCisClientRef(null), getCurrentCustomerId());

		final CisSubscriptionProfileResult result = response.getBody();
			...
			final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		...
		final ResponseEntity<CisSubscriptionData> response = getCisSubscriptionService().changeSubscriptionState(
	...
	public List<SubscriptionBillingData> getBillingActivityList(final String subscriptionId, final Map<String, String> parameters)
			throws SubscriptionFacadeException
	{
		final ResponseEntity<CisSubscriptionBillingActivityList> response = getCisSubscriptionService().getBillingActivityList(
				getCisClientRef(null), subscriptionId, null, null);
		return getCisSubscriptionBillingActivityListConverter().convert(response.getBody());
	}
	...
	public SubscriptionBillingDetailFileStream getBillingActivityDetail(final String billingActivityId,
			final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		final ResponseEntity<CisFileStreamResult> response = getCisSubscriptionService().getBillingActivityDetail(
				getCisClientRef(null), billingActivityId);
		return getCisFileStreamConverter().convert(response.getBody());
	}
			...
			throws SubscriptionFacadeException
	{
		...
		final ResponseEntity<CisSubscriptionUpgradeResult> response = getCisSubscriptionService().upgradeSubscription(
				getCisClientRef(null), request);
		...
		return getCisUpgradePreviewBillingConverter().convert(response.getBody().getFutureBillings());
	}
			...
			final Map<String, String> parameters) throws SubscriptionFacadeException
	{
		...
		for (final OrderEntryData orderEntry : orderData.getEntries())
		{
			...
			final ResponseEntity<CisSubscriptionData> response = getCisSubscriptionService().createSubscription(orderData.getGuid(),
					createRequest);
			...
			throws SubscriptionFacadeException
	{
		...
		final ResponseEntity<CisSubscriptionTransactionResult> response = getCisSubscriptionService().processPayNow(
	...
	@Required
	public void setCisPaymentConverter(final Converter<ResponseEntity, SubscriptionPaymentData> cisPaymentConverter)
	{
	...
	@Required
	public void setCisCCPaymentInfoDataConverter(final Converter<ResponseEntity, CCPaymentInfoData> cisCCPaymentInfoDataConverter)
	{
