...
<spring:url value="/quote/${ycommerce:encodeUrl(quoteData.code)}/downloadProposalDocument" var="downloadProposalDocumentUrl" htmlEscape="false" />
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3">
                <div class="item-action">
                    ...
                    <c:if test="${allowedActions['DOWNLOAD_PROPOSAL_DOCUMENT']}">
	                    <c:if test="${allowedActions['CHECKOUT'] || allowedActions['REQUOTE']}">
	                        <form:form action="${downloadProposalDocumentUrl}" target="_blank" id="downloadProposalForm" method="GET" class="url-holder">
	                            <button type="submit" class="btn btn-primary btn-block item__btn js-download-proposal-btn" id="downloadProposalButton">
