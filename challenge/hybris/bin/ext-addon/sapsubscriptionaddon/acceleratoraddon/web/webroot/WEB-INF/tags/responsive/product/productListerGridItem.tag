	...
	<ycommerce:testId code="product_wholeProduct">
		...
		<div class="details">
			...
			<ycommerce:testId code="product_productPrice">
				<div class="price"><productaddon:productListerItemPrice product="${product}"/></div>
			</ycommerce:testId>
		...
		<div class="addtocart">
			<div class="actions-container-for-${componentId} <c:if test="${ycommerce:checkIfPickupEnabledForStore() and product.availableForPickup}"> pickup-in-store-available</c:if>">
