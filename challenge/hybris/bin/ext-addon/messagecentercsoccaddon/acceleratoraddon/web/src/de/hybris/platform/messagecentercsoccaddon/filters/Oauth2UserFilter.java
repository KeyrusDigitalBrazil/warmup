 ...
 */
package de.hybris.platform.messagecentercsoccaddon.filters;
...
/**
 * Filter to add customer support agent to session
 */
public class Oauth2UserFilter implements Filter
{
